...
# -> Dans notre dataset : les colonnes 'Country' (n.0) & 'Purchased' (n.2)
# -> On va donc les enconder ces catégories sous forme de texte en valeurs
...
# et des 0 pour les pays non associés. Cela s'appelle l'encodage par demie variable.
