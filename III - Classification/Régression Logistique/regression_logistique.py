...
# Modèle lineaire basé sur une approche probabiliste
...
plt.legend()
plt.show()
# affiche une "courbe limite de prédiction" ou "prediction boundary". Le fait que ce soit une droite
# ne signifie rien d'autre que le modèle de régression logistique est linéaire. De fait elle n'arrive pas
# à classer parfaitement ses utilisateurs (il y a des rouges dans le vert et inversement). Idéalement
# on aurait donc besoin d'un courbe séparant strictement les deux utilisateurs (acheteurs ou non)